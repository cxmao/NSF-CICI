...
_PLOT_PATH = "/home/cmao/Repos/nsf-cici/results/plots/"
_SCORES_PATH = "/home/cmao/Repos/nsf-cici/results/"
...
def RunModel(params, data, field):
	...
	csvWriter = csv.writer(open(_SCORES_PATH + field + "_anomaly_scores.csv","wb"))
...
def main():
	for i in range(len(_FIELD_SELECTOR)):
		modelInput = GetData(_DISK_DATA_PATH, _FIELD_SELECTOR[0])
		fieldName = GetFieldName(modelInput[0],_FIELD_SELECTOR[0])
